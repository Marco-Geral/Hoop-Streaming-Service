...
//----------------------------------------- UPDATE SHOW ---------------------------------------------------------------------
function updateShow($requestBody)
{
...
private function getOrInsertGenre($genre)//to be honest this isn't how our database works but we can deal with that later 
                                        //at the moment how it works: we insert genres/actors without considering whether
                                        //or not they already exist in the DB so either this function can be removed from here or i can change how it works on my side
{
...
private function getOrInsertActor($actor)//as above ^^ 
{
