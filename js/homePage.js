...
function setTVShows (){// function to make request to api to change image carousel
	var req = new XMLHttpRequest();
	req.open("POST", "https://wheatley.cs.up.ac.za/u23584565/COS221/221api.php", true);//make the api request
	var images = [];
...
function processShows(images) {//function to put data from api into image carousel
