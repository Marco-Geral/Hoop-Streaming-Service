...
<div class="carousel-inner">
    <div class="carousel-item active">
        <img src="img/1.jpg" class="d-block w-100" alt="..." style="object-fit: cover; width: 100%; height: 800px;">
    ...
    <div class="carousel-item">
        <img src="img/2.jpg" class="d-block w-100" alt="..." style="object-fit: cover; width: 100%; height: 800px;">
        <div class="carousel-caption d-md-block">
            <h5 class="text-white-50 release ps-2 fs-6">NEW RELEASES</h5>
    ...
    <div class="carousel-item">
        <img src="img/3.jpg" class="d-block w-100" alt="..." style="object-fit: cover; width: 100%; height: 800px;">
        <div class="carousel-caption d-md-block">
            <h5 class="text-white-50 release ps-2 fs-6">NEW RELEASES</h5>
            <h1 class="font_80 mt-4 title">Lorem Ipsum <br> Sit Dolor</h1>
            <h6 class="text-white"><span class="rating d-inline-block rounded-circle me-2 col_green">8.2</span> <span class="col_green">IMDB SCORE</span> <span class="mx-3 year">2022</span> <span class="col_red">Romance, Action</span></h6>
            <p class="mt-4 des">Certain but she but shyness why cottage. Guy the put instrument sir entreaties affronting.</p>
            <h5 class="mb-0 mt-4 text-uppercase"><a class="button" href="#"> Watch Trailer</a></h5>
        </div>
    </div>
	...
	<!-- carousel section ends -->
			...
			<span class="span_1 pull-right d-inline-block">PG13</span></h6>
				...
				<div class="spec_1imi clearfix">
					...
					<div class="col-md-3 col-3 p-0">
					<div class="spec_1imi1r">
						<h6 class="text-white"><span class="rating d-inline-block rounded-circle me-2 col_green TVrating">6.1</span></h6>
					</div>
					</div>
				</div>
				</div>
			...
			<span class="span_1 pull-right d-inline-block">PG13</span></h6>
				...
				<div class="spec_1imi clearfix">
					...
					<div class="col-md-3 col-3 p-0">
					<div class="spec_1imi1r">
						<h6 class="text-white"><span class="rating d-inline-block rounded-circle me-2 col_green TVrating">7.1</span></h6>
					</div>
					</div>
				</div>
				</div>
			...
			<span class="span_1 pull-right d-inline-block">PG13</span></h6>
				...
				<div class="spec_1imi clearfix">
					...
					<div class="col-md-3 col-3 p-0">
					<div class="spec_1imi1r">
						<h6 class="text-white"><span class="rating d-inline-block rounded-circle me-2 col_green TVrating">8.1</span></h6>
					</div>
					</div>
				</div>
				</div>
			...
			<span class="span_1 pull-right d-inline-block">PG13</span></h6>
				...
				<div class="spec_1imi clearfix">
					...
					<div class="col-md-3 col-3 p-0">
					<div class="spec_1imi1r">
						<h6 class="text-white"><span class="rating d-inline-block rounded-circle me-2 col_green TVrating">6.9</span></h6>
					</div>
					</div>
				</div>
				</div>
			...
			<span class="span_1 pull-right d-inline-block">PG13</span></h6>
				...
				<div class="spec_1imi clearfix">
					...
					<div class="col-md-3 col-3 p-0">
					<div class="spec_1imi1r">
						<h6 class="text-white"><span class="rating d-inline-block rounded-circle me-2 col_green TVrating">8.4</span></h6>
					</div>
					</div>
				</div>
				</div>
